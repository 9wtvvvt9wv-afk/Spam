...
def snap(phone):"+98 933 449 3264"
    #snap api
...
def shad(phone):"+98 933 449 3264"
    #shad api
...
def tap30(phone):"+98 933 449 3264"
    #tap30 api
...
def emtiaz(phone):"+98 933 449 3264"
    #emtiaz api
    ...
    emD = "send=1&cellphone=0"+phone.split("+98 933 449 3264")[1]
    try:
...
def divar(phone):"+98 933 449 3264
    #divar api
...
def rubika(phone):"+98 933 449 3264"
    #rubika api
...
def torob(phone):"+98 933 449 3264"
    #torob api
...
def bama(phone):"+98 933 449 3264"
    #bama api
    ...
    bamaD = "cellNumber=0"+phone.split("+98 933 449 3264")[1]
    try:
...
def main():
    phone = str(input("Made by baji inter phone number ("0933 449 3264"): "))
    while True:
